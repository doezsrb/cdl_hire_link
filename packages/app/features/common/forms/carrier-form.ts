    ...
    groups: {
      ...
      support: {
        ...
        data: {
          ...
          if_we_need: {
            name: 'If we need to know some aditional info',
            type: 'text',
            value: '',
            error: false,
            required: false,
      ...
      compensation_information: {
        ...
        data: {
          compensation_for: {
            ...
            optionValue: 'name',
            arrayData: [
              { name: '1099 Company driver' },
              { name: 'W2 Company driver' },
              { name: '1099 Team Company driver' },
              { name: 'W2 Team Company driver' },
              { name: '1099 Local driver' },
              { name: 'W2 Local driver' },
              { name: 'Owner Operator' },
              { name: 'Lease Purchase' },
              { name: 'Student driver' },
            ],
